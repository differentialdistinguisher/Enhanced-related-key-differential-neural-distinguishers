...
def pad_and_split_hex_string(hex_str, target_length,item__length):  
    """  
    ...
    hex_chunks = [padded_hex_value[i:i+item__length] for i in range(0, len(padded_hex_value), item__length)]  
