import simeck4896_rkdiff as sm
import numpy as np
import  math
...
def make_resnet(num_blocks=2, num_filters_1=48, num_filters_2=48, num_filters_3=48, num_outputs=1, d0=512,d1=64, d2=64, word_size=24, ks=3,depth=5, reg_param=0.0001, final_activation='sigmoid',s_groups = 1,ks_value_1=1,ks_value_2=3,ks_value_3=3,dropout_value=0.5,se_ratio=24):
...
import os
def train_distinguisher(diff,key_diff,wdir,curr_time_str,num_epochs, num_rounds=7, depth=1,filename="default",s_groups=1,bs=2000,lr_choice="14",d0=512,d1=64,d2=64,ks_value_1=1,ks_value_2=3,ks_value_3=3,machine_name='vgc',dropout_value=0.8,num_filters_1=48,num_filters_2=48,num_filters_3=48,reg_param=10**-4,high_lr=0.002,low_lr=0.0001,lr_epoch=10,se_ratio=24):
