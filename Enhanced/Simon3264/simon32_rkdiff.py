...
def make_train_data_two(n, nr, diff=((0x0,0x40),(0x0,0x40)),key_diff=((0x0,0x0,0x0,0x0),(0x0,0x0,0x0,0x0)),s_groups=1):
    ...
    keys_diff = np.array([keys[0] ^ key_diff[0][0], keys[1] ^ key_diff[0][1], keys[2] ^ key_diff[0][2], keys[3] ^ key_diff[0][3]],dtype=np.uint16)
    # print([Y==0])
    # print(keys_diff[Y==0])
    # print(keys[0][Y==0])
    # keys_diff[Y==0] = np.array([keys[0][Y==0] ^ key_diff[1][0], keys[1][Y==0] ^ key_diff[1][1], keys[2][Y==0] ^ key_diff[1][2], keys[3][Y==0] ^ key_diff[1][3]],dtype=np.uint16)
