...
def make_resnet(num_blocks=2, num_filters_1=48, num_filters_2=48, num_filters_3=48, num_outputs=1, d0=512,d1=64, d2=64, word_size=24, ks=3,depth=5, reg_param=0.0001, final_activation='sigmoid',s_groups = 1,ks_value_1=1,ks_value_2=3,ks_value_3=3,dropout_value=0.8,se_ratio=24):
