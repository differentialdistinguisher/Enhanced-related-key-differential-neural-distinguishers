...
const = [0xfffffd, 0xfffffc, 0xfffffc, 0xfffffc, 0xfffffd, 0xfffffd, 0xfffffd, 0xfffffc, 0xfffffd, 0xfffffd, 0xfffffd, 0xfffffd, 0xfffffd, 0xfffffc, 0xfffffc, 0xfffffd, 0xfffffc, 0xfffffc, 0xfffffd, 0xfffffd, 0xfffffc, 0xfffffc, 0xfffffc, 0xfffffc, 0xfffffd, 0xfffffc, 0xfffffd, 0xfffffd, 0xfffffc, 0xfffffd, 0xfffffc, 0xfffffd]
# print(len(const))
...
def getdiffs(nr, n=10**4, diff=(0x0,0x40),key_diff=(0x0,0x0,0x0,0x0)):
    ...
    delta_ctdata0l = ctdata0l ^ ctdata1l
    delta_ctdata0r = ctdata0r ^ ctdata1r
    outdiffs = delta_ctdata0l*(2**WORD_SIZE())+delta_ctdata0r
...
def getdiffs_reversed(nr, n=10**4, diff=(0x0,0x40),key_diff=(0x0,0x0,0x0,0x0)):
    ...
    ctdata0l = np.frombuffer(urandom(4 * n), dtype=np.uint32) & MASK_VAL
    ctdata0r = np.frombuffer(urandom(4 * n), dtype=np.uint32) & MASK_VAL
    ...
    indiffs = delta_plain0l*(2**WORD_SIZE())+delta_plain0r
...
def check():
    ...
    # keys = np.frombuffer(urandom(16 * 1), dtype=np.uint32) & MASK_VAL
    # keys = keys.reshape(4, -1)
    # print(keys)
    ...
    keys_reversed = np.array([[3304247],[3669850],[13727783],[14638791]])
